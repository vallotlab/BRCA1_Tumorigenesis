...
###
 ...
 pdf(file.path(outputDir, "UMAP_EPITH_All_Type.pdf"), height = 8, width = 8)
print(p)
dev.off()
 ...
 pdf(file.path(outputDir, "UMAP_EPITH_All_Sample.pdf"), height = 8, width = 8)
print(p)
dev.off()


png(file.path(outputDir, "UMAP_EPITH_All_Sample.png"), height = 1500, width = 1500, res = 300)
print(p)
dev.off()
...
png(file.path(outputDir, "UMAP_EPITH_All_Hist.png"), height = 1500, width = 1500, res = 300)
print(p)
dev.off()
...
png(file.path(outputDir, "UMAP_EPITH_All_TYPE_Wo_cren1.png"), height = 1500, width = 1500, res = 300)
print(p)
dev.off()
```
...
png(file.path(outputDir, "Final_UMAP_creN_EPITH_Type_woCreN1.png"), height = 1200, width = 1200, res = 300)
print(p)
dev.off()
```
...
qs::qsave(dat_tern, file.path(outputDir, "Signatures_EpithCreN_onCreP.qs"))
dat_tern=qs::qread(file.path(outputDir, "Signatures_EpithCreN_onCreP.qs"))
...
png(file.path(outputDir, "2D_CCI.png"), height = 1500, width = 1500, res = 300)
print(g)
dev.off()
######################
...
png(file.path(outputDir, "Final2D_CREP.png"), height = 1500, width = 1500, res = 300)
print(p2)
dev.off()
